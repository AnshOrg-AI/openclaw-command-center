...
const STOP_WORDS = new Set([
    ...
    'would', 'could', 'ought', 'let', 'like', 'need', 'want', 'got', 'get',
    'make', 'made', 'see', 'look', 'think', 'know', 'take', 'come', 'go',
    'say', 'said', 'tell', 'told', 'ask', 'use', 'used', 'find', 'give',
    'gave', 'yes', 'no', 'ok', 'okay', 'yeah', 'sure', 'right', 'well',
    'also', 'just', 'really', 'actually', 'basically', 'probably', 'maybe',
    // Tech-common words that are too generic
    'file', 'code', 'run', 'check', 'help', 'please', 'thanks', 'hello',
    'hi', 'hey', 'good', 'great', 'nice', 'cool', 'awesome', 'perfect'
]);
